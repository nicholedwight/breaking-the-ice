<?php
$json = file_get_contents('http://magicseaweed.com/api/rha0P5xgEI9Nb9s3YL3M22yMa15ZH6t5/forecast/?spot_id=4298&units=eu'); //This calls the API and pulls the data from MagicSeaweed
